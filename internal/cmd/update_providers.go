...
apexcode update-providers https://example.com/providers.json
...
apexcode update-providers --source=hyper

# Update Hyper from a custom URL
apexcode update-providers --source=hyper https://hyper.example.com
`,

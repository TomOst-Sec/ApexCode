...
func TestModelList_RecentlyUsedSectionAndPrunesInvalid(t *testing.T) {
	...
	confPath := filepath.Join(cfgDir, "apexcode", "apexcode.json")
	...
	dataConfDir := filepath.Join(dataDir, "apexcode")
	...
	origConfPath := filepath.Join(cfgDir, "apexcode", "apexcode.json")
	...
	dataConf := filepath.Join(dataDir, "apexcode", "apexcode.json")

...
<p align="center">
    <strong>Terminal AI coding assistant</strong><br />
...
- **Industrial Grade:** production-ready TUI built on the bubbletea ecosystem
...
git clone https://github.com/TomOst-Sec/ApexCode.git
cd ApexCode
...
- `trailer_style`: Controls the attribution trailer added to commit messages
  (default: `assisted-by`)
	- `assisted-by`: Adds `Assisted-by: [Model Name] via ApexCode <noreply@apexcode.dev>`
	  (includes the model name)
	- `co-authored-by`: Adds `Co-Authored-By: ApexCode <noreply@apexcode.dev>`
...
an open source provider database. This means that when new providers and
...
[FSL-1.1-MIT](https://github.com/TomOst-Sec/ApexCode/blob/main/LICENSE.md)
